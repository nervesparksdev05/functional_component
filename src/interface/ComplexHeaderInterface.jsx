...
export default function ComplexHeaderInterface() {
  return (
    <header className="w-full bg-[#FFFFFF]">
      {/* Top bar – 76px height */}
      <div className="w-full h-[75.92px] border-b border-[#BDC1CA] flex items-center">
        <div className="w-full flex items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Profile avatar */}
            <div className="hidden sm:block w-9 h-9 rounded-full overflow-hidden bg-[#E5E7EB] mr-18">
              <img
                src={FemaleIcon}
                alt="Profile"
      ...
      <div className="w-full h-[68px] border-b border-[#BDC1CA] flex items-center">
